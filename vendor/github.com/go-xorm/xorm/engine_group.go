...
// ShowExecTime show SQL statement and execute time or not on logger if logger level is great than INFO
...
// ShowSQL show SQL statement or not on logger if logger level is great than INFO
